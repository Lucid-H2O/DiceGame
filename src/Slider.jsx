    ...
    <div className='mt-10 mb-32 w-[708px] mx-auto'>
      ...
      <div className='p-1 bg-[#69869a] rounded-full'>
        <div className="relative border-solid h-4 w-full border-1 border-black z-[1000] rounded-full">
            <div id='under' className={`${ props.over ? 'bg-[#c72e2e]' : 'bg-[#19a819]'} w-2/4 h-full clear-both z-20 absolute rounded-l-xl`}></div>
            <div id='over' className={`${ props.over ? 'bg-[#19a819]' : 'bg-[#c72e2e]'} w-full h-full clear-both z-10 absolute rounded-full`}></div>
